 ...
 * Class Description: 
 * 		This class is responsible for rendering, updating and controlling the pink ghost
...
public class PinkGhost extends Actor {
	...
	public void getPinkGhostImage() {
		try {
			idle1 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostStill.png"));
			up1 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostUp1.png"));
			up2 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostUp2.png"));
			down1 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostDown1.png"));
			down2 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostDown2.png"));
			left1 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostLeft1.png"));
			left2 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostLeft2.png"));
			right1 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostRight1.png"));
			right2 = ImageIO.read(getClass().getResource("/ghost/pinkghost/pinkGhostRight2.png"));
	...
	public void setAction(int state) {
		...
		if (state == runState) {
			if (onPath == true) {
				// BOTTOM RIGHT
				searchPath((engine.tileSize * 1) / engine.tileSize, (engine.tileSize * 22) / engine.tileSize);
			}
		}
	}
